...
var saber2pr = (function () {
	...
	*/
	...
	var FoldNode = function (_a) {
	    var props = _a.props, style = _a.style, cur = _a.cur, onEnter = _a.onEnter;
	    var div = style.div, hr = style.hr;
	    return (react_1.default.createElement(fold.Fold, { props: props, maxSize: record(cur, 6), render: function (_a, index) {
	            var name = _a.name;
	...
	var ContentNode = function (_a) {
	    var props = _a.props, style = _a.style, onOut = _a.onOut, current = _a.current, onDelete = _a.onDelete;
	    ...
	    return (react_1.default.createElement("div", null,
	        ...
	        react_1.default.createElement(button.Button, { name: "\u7F16\u8F91", style: button$$1 }),
	        react_1.default.createElement(button.Button, { name: "\u5220\u9664", style: button$$1, onClick: function () {
	                onOut();
	                onDelete(current);
	            } }),
	...
	exports.Content = function (_a) {
	    var props = _a.props, style = _a.style, onDelete = _a.onDelete;
	    ...
	    if (state === 'out') {
	        return (react_1.default.createElement(FoldNode, { props: props, style: style, cur: cur, onEnter: function (index) { return Enter(index); } }));
	    }
	    else if (state === 'enter') {
	        return (react_1.default.createElement(ContentNode, { props: props, style: style, onOut: Out, current: cur, onDelete: onDelete }));
	    }
	};
	});
	...
	var Tabs = function (_a) {
	    var props = _a.props, style = _a.style, onContentDelete = _a.onContentDelete;
	    return (react_1.default.createElement(tab.TabV, { col: '25% 75%', active: css.tabVcss.active, unactive: css.tabVcss.unactive }, Array.from(new Set(props.map(function (v) { return v.type; }))).map(function (t) { return (react_1.default.createElement(tab.Tab, { name: t },
	        react_1.default.createElement(blog_content.Content, { props: search.find(props, function (v) { return v.type === t; }), style: style, onDelete: onContentDelete }))); })));
	};
	exports.Blog = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("div", { style: div },
	            ...
	            react_1.default.createElement(Tabs, { props: data, style: style, onContentDelete: function (index) { } }))));
	};
	});
