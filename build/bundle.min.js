...
var saber2pr = (function () {
	...
	*/
	...
	exports.Columns = function (_a) {
	    ...
	    var div = style.div;
	    return (react_1.default.createElement("div", { style: __assign({}, div, { display: 'grid', gridTemplateColumns: (" " + 100 / size + "% ").repeat(size) }) }, children));
	};
	});
	...
	exports.LinkImg = function (_a) {
	    var props = _a.props, style = _a.style;
	    var a = style.a, img = style.img, p = style.p, div = style.div;
	    return (react_1.default.createElement(react_1.default.Fragment, null, props.map(function (_a, index) {
	        var name = _a.name, href = _a.href, src = _a.src, infor = _a.infor;
	        return (react_1.default.createElement(column.Columns, { props: { size: 3 }, style: { div: div } },
	            react_1.default.createElement("div", null,
	                react_1.default.createElement(anchor.Anchor, { props: { name: name, href: href }, style: { a: a }, key: index })),
	            react_1.default.createElement("div", null,
	...
	exports.Home = function (_a) {
	    ...
	    var p = style.p, img = style.img, a = style.a;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        ...
	        react_1.default.createElement(link.Link, { props: websites, style: { a: a } })));
	};
	});
	...
	exports.Search = function (_a) {
	    var props = _a.props, onChange = _a.onChange;
	    ...
	    return react_1.default.createElement("input", { type: "text", style: { marginTop: '30px' }, onChange: change });
	};
	});
	...
	exports.Project = function (_a) {
	    var props = _a.props, style = _a.style;
	    var p = style.p, div = style.div;
	    var _b = react_1.useState(props), searched = _b[0], setSearched = _b[1];
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(column.Columns, { props: { size: 3 }, style: { div: div } },
	        ...
	        react_1.default.createElement(search.Search, { props: props, onChange: function (v) { return setSearched(v); } }),
	...
	exports.About = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        ...
	        react_1.default.createElement(link.Link, { props: links, style: { a: a } })));
	};
	});
	...
	var about$2 = {
		title: "说明",
		content: "这是一个用来组织和导航saber2pr/Repositories的页面。使用react（16.8.2）编写，配色风格参考Dracula Official。语言为React-Typescript（tsx），层叠样式表为css in js，栅格布局为grid格式。采用函数组件，状态更新使用React-Hooks，tab导航原理为props.children动态更新，a标签hover原理为onMouseOver & onMouseOut动态切换css阴影。项目的单元工具（utils）已经同步到npm。",
	...
	var require$$0 = getCjsExportFromNamespace(data$1);
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.data = require$$0;
	var tabsLength = Object.keys(exports.data).length - 1;
	exports.globalcss = {
	    body: {
	...
	exports.tabscss = {
	    active: {
	        button: __assign({}, exports.globalcss.button, { color: '#6272a4', backgroundColor: '#282a36', boxShadow: '#000000 -5px 5px 10px' }),
	        bottom: exports.globalcss.bottom,
	        hr: exports.globalcss.hr
	    },
	    unactive: {
	        button: __assign({}, exports.globalcss.button, { color: '#2a334d', backgroundColor: '#191a21', boxShadow: '' }),
	        bottom: exports.globalcss.bottom,
	        hr: exports.globalcss.hr
	    }
	};
	exports.projectcss = {
	    ...
	    a: __assign({}, exports.globalcss.a, { fontSize: '100%' }),
	    p: __assign({}, exports.globalcss.p, { fontSize: '100%', width: '70%', margin: '30px auto', lineHeight: '150%' })
	};
	exports.aboutcss = {
	    p: __assign({}, exports.globalcss.p, { width: '70%', margin: '30px auto', lineHeight: '150%' }),
	    a: exports.globalcss.a
	};
	});

	unwrapExports(css);
	var css_1 = css.data;
	var css_2 = css.globalcss;
	var css_3 = css.tabscss;
	var css_4 = css.projectcss;
	var css_5 = css.aboutcss;
	...
	var Application = function (_a) {
	    var home$$1 = _a.home, project$$1 = _a.project, about$$1 = _a.about, common = _a.common;
	...
	react_dom_1.default.render(react_1.default.createElement(Application, __assign({}, css.data)), style.style(document.querySelector('body'))(css.globalcss.body));
	});
