...
var saber2pr = (function () {
	...
	*/
	...
	var colsplit = function (size) { return (" " + 100 / size + "% ").repeat(size); };
	exports.Columns = function (_a) {
	    ...
	    var div = style.div;
	    return (react_1.default.createElement("div", { style: __assign({}, div, { display: 'grid', gridTemplateColumns: props.col || colsplit(size) }) }, children));
	};
	});

	unwrapExports(column);
	var column_1 = column.Columns;
	...
	exports.Button = function (_a) {
	    var style$$1 = _a.style, key = _a.key, onClick = _a.onClick, name = _a.name, isactive = _a.isactive, activeStyle = _a.activeStyle, unactiveStyle = _a.unactiveStyle;
	    return (react_1.default.createElement("button", { style: style$$1, key: key, onClick: onClick, onMouseOver: over(activeStyle), onMouseOut: out(activeStyle, unactiveStyle)(isactive) }, name));
	};
	});
	...
	function Tabs(_a) {
	    var children = _a.children, active = _a.active, unactive = _a.unactive, bottom = _a.bottom;
	    var _b = react_1.useState(0), cur = _b[0], update = _b[1];
	    return (react_1.default.createElement(react_1.default.Fragment, null, react_1.default.Children.map(children, function (node, index) { return (react_1.default.createElement(button.Button, { style: index === cur ? active.button : unactive.button, key: index, onClick: function () { return update(index); }, activeStyle: active.button, unactiveStyle: unactive.button, name: node['props']['name'], isactive: index === cur })); })
	        .concat(children[cur] || children)
	        .concat(react_1.default.createElement("hr", { style: active.hr }))
	        .concat(react_1.default.createElement("div", { style: active.bottom }, bottom))));
	}
	exports.Tabs = Tabs;
	exports.TabV = function (_a) {
	    var children = _a.children, active = _a.active, unactive = _a.unactive, col = _a.col;
	    var _b = react_1.useState(0), cur = _b[0], update = _b[1];
	    var tabs = react_1.default.Children.map(children, function (node, index) { return (react_1.default.createElement("div", null,
	        react_1.default.createElement(button.Button, { style: index === cur ? active.button : unactive.button, key: index, onClick: function () { return update(index); }, name: node['props']['name'], activeStyle: active.button, unactiveStyle: unactive.button, isactive: index === cur }))); });
	    var content = children[cur] || children;
	...
	exports.Anchor = function (_a) {
	    var name = _a.name, href = _a.href, style$$1 = _a.style, onClick = _a.onClick;
	    var a = style$$1.a;
	    return (react_1.default.createElement("a", { href: href, style: a, onMouseOver: over, onMouseOut: out, onClick: onClick }, name));
	};
	});
	...
	function Fold(_a) {
	    var props = _a.props, maxSize = _a.maxSize, style$$1 = _a.style, render = _a.render;
	    var button = style$$1.button;
	    var _b = react_1.useState(maxSize || 3), maxsize = _b[0], setMaxSize = _b[1];
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null, viewprops
	        ...
	        .concat(react_1.default.createElement("button", { style: button, onClick: function () { return setMaxSize(maxsize * 2); }, onMouseOver: over, onMouseOut: out(button) }, maxsize < props.length ? '更多' : '到底了'))));
	}
	exports.Fold = Fold;
	});
	...
	exports.Link = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null, props.map(function (_a, index) {
	        ...
	        return (react_1.default.createElement("div", { key: index },
	            react_1.default.createElement(anchor.Anchor, { name: name, href: href, style: style, key: index })));
	    })));
	};
	exports.LinkImg = function (_a) {
	    var props = _a.props, style = _a.style;
	    var img = style.img, p = style.p;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(fold.Fold, { props: props, style: style, render: function (_a, index) {
	                ...
	                return (react_1.default.createElement(column.Columns, { props: { size: 3 }, style: style },
	                    react_1.default.createElement("div", null,
	                        react_1.default.createElement(anchor.Anchor, { name: name, href: href, style: style, key: index })),
	                    react_1.default.createElement("div", null,
	                        react_1.default.createElement("img", { src: src, alt: name, style: img, key: index })),
	                    react_1.default.createElement("div", null,
	...
	exports.Home = function (_a) {
	    var props = _a.props, style = _a.style;
	    var title = props.title, logo = props.logo, author = props.author, readME = props.readME, websites = props.websites;
	...
	function Search(_a) {
	    var props = _a.props, onChange = _a.onChange, style = _a.style;
	    ...
	    var defaultValue = '搜索...';
	    return (react_1.default.createElement("input", { type: "text", style: input, onChange: change, onFocus: onFocus(defaultValue), onBlur: onBlur(defaultValue), defaultValue: defaultValue }));
	}
	...
	var project = createCommonjsModule(function (module, exports) {
	var __importStar = (commonjsGlobal && commonjsGlobal.__importStar) || function (mod) {
	    if (mod && mod.__esModule) return mod;
	    var result = {};
	    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];
	...
	exports.Project = function (_a) {
	    var props = _a.props, style = _a.style;
	    var p = style.p;
	    var _b = react_1.useState(props), searched = _b[0], setSearched = _b[1];
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(search.Search, { props: props, onChange: function (v) { return setSearched(v); }, style: style }),
	        ...
	        react_1.default.createElement(link.LinkImg, { props: searched, style: style })));
	};
	});

	unwrapExports(project);
	var project_1 = project.Project;
	...
	exports.blogcss = {
	    ...
	    hr: {},
	    button: __assign({}, globalcss.globalcss.button, { color: '#2a334d', background: '#252633', border: '1px solid #282a36', marginTop: '5%', marginBottom: '5%' }),
	    input: __assign({}, globalcss.globalcss.input, { marginTop: '10px', marginBottom: '15px' }),
	    a: __assign({}, globalcss.globalcss.a, { margin: '0 auto', fontSize: '100%', cursor: 'pointer', lineHeight: '10%' }),
	    p: __assign({}, globalcss.globalcss.p, { fontSize: '90%', color: '#799cb9' }),
	...
	var useData_1 = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });

	function useData(props) {
	    var _a = react.useState(props), data = _a[0], setData = _a[1];
	    var del = function (index) {
	        data.splice(index, 1);
	        console.log('del');
	        setData(data);
	    };
	    var save = function (value, index) {
	        data[index] = value;
	        setData(data);
	    };
	    var create = function (blog) {
	        data.unshift(blog);
	        setData(data);
	    };
	    return { data: data, save: save, del: del, create: create, setData: setData };
	}
	exports.useData = useData;
	});

	unwrapExports(useData_1);
	var useData_2 = useData_1.useData;
	...
	exports.ContentEditor = function (_a) {
	    var props = _a.props, style = _a.style, onOut = _a.onOut, index = _a.index;
	    var button$$1 = style.button, textarea = style.textarea, p = style.p;
	    var content = props[index] || props[0];
	    var save = useData_1.useData(props).save;
	    var inputcss = {
	    ...
	    return (react_1.default.createElement("div", null,
	        react_1.default.createElement("div", null,
	            react_1.default.createElement("span", { style: pcss }, "\u6807\u9898\uFF1A"),
	            react_1.default.createElement("input", { type: "text", defaultValue: content.name, style: inputcss, onChange: function (e) { return (content.name = e.target.value); } })),
	        react_1.default.createElement("div", null,
	            react_1.default.createElement("span", { style: pcss }, "\u5206\u7C7B\uFF1A"),
	            react_1.default.createElement("input", { type: "text", defaultValue: content.type, style: inputcss, onChange: function (e) { return (content.type = e.target.value); } })),
	        react_1.default.createElement("div", null,
	            react_1.default.createElement("textarea", { defaultValue: content.content, style: textarea, onChange: function (e) { return (content.content = e.target.value); } })),
	        react_1.default.createElement(button.Button, { style: button$$1, name: '保存', onClick: function () {
	                save(content, index);
	                onOut();
	            } }),
	        react_1.default.createElement(button.Button, { style: button$$1, name: '返回', onClick: onOut })));
	};
	});
	...
	exports.ContentEnter = function (_a) {
	    var props = _a.props, style = _a.style, onOut = _a.onOut, current = _a.current, onEdit = _a.onEdit;
	    var p = style.p, button$$1 = style.button;
	    var content = props[current] || props[0];
	    var del = useData_1.useData(props).del;
	    var _b = react_1.useState('删除'), delState = _b[0], setDelState = _b[1];
	    return (react_1.default.createElement("div", null,
	        react_1.default.createElement("h1", { style: p }, content.name),
	        react_1.default.createElement("p", { style: p }, content.content),
	        react_1.default.createElement(button.Button, { name: "\u7F16\u8F91", style: button$$1, onClick: function () { return onEdit(current); } }),
	        react_1.default.createElement(button.Button, { name: delState, style: button$$1, onClick: function () {
	                if (delState === '删除') {
	                    setDelState('确定删除？');
	                }
	        ...
	        react_1.default.createElement(button.Button, { name: '返回', onClick: onOut, style: button$$1 })));
	};
	});
	...
	exports.ContentFold = function (_a) {
	    var props = _a.props, style = _a.style, current = _a.current, onEnter = _a.onEnter;
	    var div = style.div, hr = style.hr;
	    return (react_1.default.createElement(fold.Fold, { props: props, maxSize: record(current, 6), render: function (_a, index) {
	            var name = _a.name;
	            return (react_1.default.createElement("div", { style: div },
	                react_1.default.createElement(anchor.Anchor, { name: name, href: '#', style: style, onClick: function () {
	                        onEnter(index);
	                    } }),
	...
	exports.Content = function (_a) {
	    var props = _a.props, style = _a.style;
	    var _b = react_2.useState('out'), state = _b[0], setState = _b[1];
	    var _c = react_2.useState(0), cur = _c[0], setCur = _c[1];
	    var Out = function () {
	        setState('out');
	    };
	    ...
	    if (state === 'out') {
	        return (react_1.default.createElement(blog_content_fold.ContentFold, { props: props, style: style, current: cur, onEnter: function (index) { return Enter(index); } }));
	    }
	    else if (state === 'enter') {
	        return (react_1.default.createElement(blog_content_enter.ContentEnter, { props: props, style: style, current: cur, onOut: Out, onEdit: Edit }));
	    }
	    else if (state === 'edit') {
	        return (react_1.default.createElement(blog_content_edit.ContentEditor, { props: props, style: style, index: cur, onOut: function () { return Enter(cur); } }));
	    }
	};
	});
	...
	var blog = createCommonjsModule(function (module, exports) {
	var __importStar = (commonjsGlobal && commonjsGlobal.__importStar) || function (mod) {
	    if (mod && mod.__esModule) return mod;
	    var result = {};
	    if (mod != null) for (var k in mod) if (Object.hasOwnProperty.call(mod, k)) result[k] = mod[k];
	...
	exports.Blog = function (_a) {
	    var props = _a.props, style = _a.style;
	    var div = style.div;
	    var _b = react_1.useState(props), data = _b[0], setData = _b[1];
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("div", { style: div },
	            react_1.default.createElement(column.Columns, { props: { size: 2, col: '25% 75%' } },
	                react_1.default.createElement("div", null,
	                    react_1.default.createElement(button.Button, { name: '写新日志', style: style.button })),
	                react_1.default.createElement("div", null,
	                    react_1.default.createElement(search.Search, { props: data, onChange: function (v) { return setData(v); }, style: style }))),
	            react_1.default.createElement(tab.TabV, { col: '25% 75%', active: css.tabVcss.active, unactive: css.tabVcss.unactive }, Array.from(new Set(props.map(function (v) { return v.type; }))).map(function (t) { return (react_1.default.createElement(tab.Tab, { name: t },
	                react_1.default.createElement(blog_content.Content, { props: search.find(props, function (v) { return v.type === t; }), style: style }))); })))));
	};
	});

	unwrapExports(blog);
	var blog_1 = blog.Blog;

	var about = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.About = function (_a) {
	    var props = _a.props, style = _a.style;
	    var title = props.title, content = props.content, more = props.more, contact = props.contact, links = props.links;
	    var p = style.p;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("h1", { style: p }, title),
	...
	var blog$2 = [
		...
		},
		{
			name: "测试",
			type: "开发日志",
			content: "这是测试editor脚本。"
		},
		{
			name: "测试2",
			type: "开发日志",
			content: "这是测试editor脚本（2）。"
		},
		{
			name: "测试3",
			type: "开发日志",
			content: "这是测试editor脚本（3）。"
		},
		{
			name: "测试4",
			type: "开发日志",
			content: "这是测试editor脚本（4）。"
		},
		{
			name: "测试5",
			type: "开发日志",
			content: "这是测试editor脚本（5）。"
		},
		{
			name: "测试6",
			type: "开发日志",
			content: "这是测试editor脚本（6）。"
		},
		{
			name: "测试7",
			type: "开发日志",
			content: "这是测试editor脚本（7）。"
		},
		{
			name: "测试8",
			type: "开发日志",
			content: "这是测试editor脚本（8）。"
		},
		{
			name: "测试9",
			type: "开发日志",
			content: "这是测试editor脚本（9）。"
		},
		{
			name: "内容测试",
			type: "分类测试",
	...
	var about$2 = {
		title: "说明",
		content: "这是一个用来组织和导航saber2pr/Repositories的页面，由json数据渲染而成。使用react（16.8.2）编写，配色风格参考Dracula Official。语言为React-Typescript（tsx），层叠样式表为css in js，栅格布局为grid格式。采用函数组件，状态更新使用React-Hooks。tab导航原理为props.children动态渲染，a标签hover原理为onMouseOver & onMouseOut动态切换css阴影，input搜索原理为正则match & children动态渲染，列表折叠原理为数组slice & children动态渲染。Blog | Project 页面内容添加方式为nodejs脚本，json对象的序列化与反序列化并写入json文件持久化。项目的单元工具（utils）已经同步到npm。",
		more: "更多信息请移步github.com/Saber2pr/saber2pr。",
		contact: "联系",
		links: [
			{
	...
	var Application = function (_a) {
	    var home$$1 = _a.home, project$$1 = _a.project, blog$$1 = _a.blog, about$$1 = _a.about, common = _a.common;
	    var footer = common.footer;
	    var div = css.globalcss.div;
	    return (react_1.default.createElement("div", { style: div },
	        react_1.default.createElement(tab.Tabs, { active: css.tabscss.active, unactive: css.tabscss.unactive, bottom: footer },
	            react_1.default.createElement(tab.Tab, { name: "Home" },
	                react_1.default.createElement(home.Home, { props: home$$1, style: homecss.homecss })),
	            react_1.default.createElement(tab.Tab, { name: "Blog" },
	                react_1.default.createElement(blog.Blog, { props: blog$$1, style: css.blogcss })),
	            react_1.default.createElement(tab.Tab, { name: "Project" },
	                react_1.default.createElement(project.Project, { props: project$$1, style: css.projectcss })),
	            react_1.default.createElement(tab.Tab, { name: "About" },
	                react_1.default.createElement(about.About, { props: about$$1, style: css.aboutcss })))));
	};
	react_dom_1.default.render(react_1.default.createElement(Application, __assign({}, data$2)), style.style(document.querySelector('body'))(css.globalcss.body));
	});

	var Application = unwrapExports(Application_1);
