...
var saber2pr = (function () {
	...
	*/
	...
	function x$1(a){for(var b=arguments.length-1,c="https://reactjs.org/docs/error-decoder.html?invariant="+a,d=0;d<b;d++)c+="&args[]="+encodeURIComponent(arguments[d+1]);ba$1(!1,"Minified React error #"+a+"; visit %s for the full message or use the non-minified dev environment for full errors and additional helpful warnings. ",c);}react_production_min?void 0:x$1("227");function ca$1(a,b,c,d,e,f,g,h,l){var k=Array.prototype.slice.call(arguments,3);try{b.apply(c,k);}catch(m){this.onError(m);}}
	...
	null;delete a[b];}}}}function Rb(a){a._valueTracker||(a._valueTracker=Qb(a));}function Sb(a){if(!a)return !1;var b=a._valueTracker;if(!b)return !0;var c=b.getValue();var d="";a&&(d=Pb(a)?a.checked?"true":"false":a.value);a=d;return a!==c?(b.setValue(a),!0):!1}var Tb=react_production_min.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED;Tb.hasOwnProperty("ReactCurrentDispatcher")||(Tb.ReactCurrentDispatcher={current:null});
	...
	case "keydown":case "keyup":return Xd(c,d)}return null}};Ba.injectEventPluginOrder("ResponderEventPlugin SimpleEventPlugin EnterLeaveEventPlugin ChangeEventPlugin SelectEventPlugin BeforeInputEventPlugin".split(" "));ta=Ka;ua=Ia;va=Ja;Ba.injectEventPluginsByName({SimpleEventPlugin:xd,EnterLeaveEventPlugin:ad,ChangeEventPlugin:Pc,SelectEventPlugin:Yd,BeforeInputEventPlugin:zb});function Zd(a){var b="";react_production_min.Children.forEach(a,function(a){null!=a&&(b+=a);});return b}
	...
	function hf(a){var b=a._result;switch(a._status){case 1:return b;case 2:throw b;case 0:throw b;default:a._status=0;b=a._ctor;b=b();b.then(function(b){0===a._status&&(b=b.default,a._status=1,a._result=b);},function(b){0===a._status&&(a._status=2,a._result=b);});switch(a._status){case 1:return a._result;case 2:throw a._result;}a._result=b;throw b;}}var jf=(new react_production_min.Component).refs;
	...
	var saberObservable = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	/*
	 * @Author: saber2pr
	...
	var Observable = /** @class */ (function () {
	    ...
	    Observable.prototype.unsubscribe = function (observer) {
	        this.observers = this.observers.filter(function (obser) { return obser !== observer; });
	        return this;
	    };
	    /**
	     * pipe
	    ...
	    Observable.prototype.pipe = function () {
	        ...
	        var reducer = compose.apply(void 0, funcs.reverse());
	        var nextState = reducer(this.getState());
	     ...
	     * @memberof Observable
	     */
	    Observable.prototype.dispatch = function (nextState) {
	        var _this = this;
	        if (nextState === void 0) { nextState = this.getState(); }
	        this.observers.forEach(function (observer) { return observer(nextState, _this.getState()); });
	     ...
	     * @memberof Observable
	     */
	    Observable.prototype.getInitState = function () {
	    ...
	    Observable.prototype.setState = function (state) {
	        if (typeof state === 'function') {
	            return this.dispatch(Object.assign(exports.clone(this.getState()), state(this.getState())));
	        }
	        else {
	            return this.dispatch(Object.assign(exports.clone(this.getState()), state));
	        }
	    };
	    return Observable;
	}());
	...
	unwrapExports(saberObservable);
	var saberObservable_1 = saberObservable.compose;
	var saberObservable_2 = saberObservable.clone;
	var saberObservable_3 = saberObservable.Observable;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__export(saberObservable);
	});

	unwrapExports(lib);

	var saberAjax = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	/**
	 * Ajax
	 * @param url
	 ...
	 */
	exports.Ajax = function (url, value) {
	    return new Promise(function (resolve, reject) {
	        var method = value ? 'POST' : 'GET';
	...
	unwrapExports(saberAjax);
	var saberAjax_1 = saberAjax.Ajax;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.state_reset = function (init) { return function (state) {
	    return init || __assign({}, state, { tabCur: 0 });
	}; };
	exports.blog_state_reset = function (state) { return (__assign({}, state, { blog: {
	...
	exports.blog_items = function (items) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { items: items }) })); }; };
	exports.blog_items_reset = function (items) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { items: items }) })); }; };
	exports.blog_content_state = function (type) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { contentState: type }) })); }; };
	exports.blog_content_index = function (index) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { contentCur: index }) })); }; };
	exports.blog_content_del = function (name) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { items: state.blog.items.filter(function (b) { return b.name !== name; }) }) })); }; };
	exports.blog_state = function (type) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { blogState: type }) })); }; };
	exports.blog_tab_index = function (index) { return function (state) { return (__assign({}, state, { blog: __assign({}, state.blog, { tabCur: index }) })); }; };
	exports.project_reset = function (project) { return function (state) { return (__assign({}, state, { project: project })); }; };
	});

	unwrapExports(operations);
	var operations_1 = operations.state_reset;
	var operations_2 = operations.blog_state_reset;
	var operations_3 = operations.blog_items;
	var operations_4 = operations.blog_items_reset;
	var operations_5 = operations.blog_content_state;
	var operations_6 = operations.blog_content_index;
	var operations_7 = operations.blog_content_del;
	var operations_8 = operations.blog_state;
	var operations_9 = operations.blog_tab_index;
	var operations_10 = operations.project_reset;
	...
	var about = {
		title: "说明",
		content: "这是一个用来组织和导航saber2pr/Repositories的页面，由json数据渲染而成。使用react（16.8.2）编写，配色风格参考Dracula Official。语言为React-Typescript（tsx），层叠样式表为css in js，栅格布局为grid格式。采用函数组件，状态更新使用React-Hooks，状态管理使用Observable订阅观察。tab导航原理为props.children动态渲染，a标签hover原理为onMouseOver & onMouseOut动态切换css阴影，input搜索原理为正则match & children动态渲染，列表折叠原理为数组slice & children动态渲染，代码插入利用pre标签和scroll样式(overflow:hidden)，关键字高亮利用正则匹配和字符串split & map 处理(详见utils/highlight)。使用json接口，json对象序列化并post到server端持久化，server端使用nodejs-http模块搭建。前端页面默认使用样例假数据。 项目的单元工具（utils）已经同步到npm。",
	...
	var State = getCjsExportFromNamespace(state$1);
	...
	exports.Store$ = new lib.Observable(State);
	// get data from server
	lib$1.Ajax('/src/store/state.json')
	    .then(function (value) {
	    return exports.Store$.pipe(operations.state_reset(JSON.parse(value)), operations.blog_state_reset);
	})
	    .catch(function (err) {
	    console.warn('connect server fail!', err);
	    exports.Store$.pipe(operations.state_reset(), operations.blog_state_reset);
	});
	// post data to server
	exports.Store$.subscribe(function (data) {
	    lib$1.Ajax('/src/store/state.json', JSON.stringify(data))
	        .then(function () { return console.log('post ok!'); })
	        .catch(function (err) { return console.warn('post fail!', err); });
	});
	});

	unwrapExports(store);
	var store_1 = store.Store$;

	var style = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.style = function (target) { return function (style) {
	    Object.keys(style).forEach(function (key) { return (target['style'][key] = style[key]); });
	    return target;
	}; };
	});
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var react_1 = __importDefault(react_production_min);
	exports.colsplit = function (size) { return (" " + 100 / size + "% ").repeat(size); };
	exports.Columns = function (_a) {
	    var props = _a.props, children = _a.children, _b = _a.style, style = _b === void 0 ? { div: {} } : _b;
	    var size = props.size || 1;
	    var div = style.div;
	    return (react_1.default.createElement("div", { style: __assign({}, div, { display: 'grid', gridTemplateColumns: props.col || exports.colsplit(size) }) }, children));
	};
	});

	unwrapExports(column);
	var column_1 = column.colsplit;
	var column_2 = column.Columns;
	...
	var active = { color: '#6272a4' };
	var unactive = { color: '#2a334d' };
	var over = function (activeStyle) {
	    if (activeStyle === void 0) { activeStyle = active; }
	    return function (event) { return style.style(event.target)(activeStyle); };
	};
	var out = function (activeStyle, unactiveStyle) {
	    if (activeStyle === void 0) { activeStyle = active; }
	    if (unactiveStyle === void 0) { unactiveStyle = unactive; }
	    return function (isactive) { return function (event) { return style.style(event.target)(isactive ? activeStyle : unactiveStyle); }; };
	};
	exports.Button = function (_a) {
	    var _b = _a.style, style = _b === void 0 ? {} : _b, _c = _a.onClick, onClick = _c === void 0 ? function () { } : _c, name = _a.name, isactive = _a.isactive, activeStyle = _a.activeStyle, unactiveStyle = _a.unactiveStyle;
	    return (react_1.default.createElement("button", { style: style, onClick: onClick, onMouseOver: over(activeStyle), onMouseOut: out(activeStyle, unactiveStyle)(isactive) }, name));
	};
	});
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var react_1 = __importStar(react_production_min);


	exports.Tab = function (props) { return react_1.default.createElement("div", __assign({}, props), props.children); };
	function Tabs(_a) {
	    var children = _a.children, _b = _a.active, active = _b === void 0 ? {
	        bottom: {},
	        button: {},
	        hr: {}
	    } : _b, _c = _a.unactive, unactive = _c === void 0 ? {
	        bottom: {},
	        button: {},
	        hr: {}
	    } : _c, bottom = _a.bottom, current = _a.current, onClick = _a.onClick;
	    var _d = react_1.useState(current || 0), cur = _d[0], update = _d[1];
	    return (react_1.default.createElement(react_1.default.Fragment, null, react_1.default.Children.map(children, function (node, index) { return (react_1.default.createElement(button.Button, { style: index === cur ? active.button : unactive.button, key: "jssk8glndd94bj470pn" + index, onClick: function () {
	            !!onClick ? onClick(index) : null;
	            update(index);
	        }, activeStyle: active.button, unactiveStyle: unactive.button, name: node['props']['name'], isactive: index === cur })); })
	        .concat(children[cur] || children)
	        .concat(react_1.default.createElement("hr", { style: active.hr, key: "jssk91tow4yu2vi8oor" }))
	        .concat(react_1.default.createElement("div", { style: active.bottom, key: "jssk97jyinb1jtq2mu" }, bottom))));
	}
	exports.Tabs = Tabs;
	exports.TabV = function (_a) {
	    var children = _a.children, _b = _a.active, active = _b === void 0 ? {
	        button: {}
	    } : _b, _c = _a.unactive, unactive = _c === void 0 ? {
	        button: {}
	    } : _c, col = _a.col, current = _a.current, onClick = _a.onClick;
	    var array = react_1.default.Children.toArray(children);
	    current = current < array.length ? current : array.length - 1;
	    var tabs = array.map(function (node, index) { return (react_1.default.createElement("div", { key: "jssk9kdv3ikyxb755fw" + index },
	        react_1.default.createElement(button.Button, { style: index === current ? active.button : unactive.button, onClick: function () {
	                !!onClick ? onClick(index) : null;
	            }, name: node['props']['name'], activeStyle: active.button, unactiveStyle: unactive.button, isactive: index === current }))); });
	    var content = children[current] || children;
	    return (react_1.default.createElement(column.Columns, { props: { size: 2, col: col } },
	        react_1.default.createElement("div", null, tabs),
	...
	var anchor = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var over = function (event) {
	    return style.style(event.target)({
	...
	exports.Anchor = function (_a) {
	    var name = _a.name, href = _a.href, _b = _a.style, style = _b === void 0 ? {} : _b, _c = _a.onClick, onClick = _c === void 0 ? function () { } : _c;
	    return (react_1.default.createElement("a", { href: href, style: style, onMouseOver: over, onMouseOut: out, onClick: onClick }, name));
	};
	});

	unwrapExports(anchor);
	var anchor_1 = anchor.Anchor;
	...
	var out = function (button) { return function (event) { return style.style(event.target)(button); }; };
	function Fold(_a) {
	    var props = _a.props, maxSize = _a.maxSize, _b = _a.style, style = _b === void 0 ? { button: {} } : _b, render = _a.render;
	    var button = style.button;
	    var _c = react_1.useState(maxSize || 3), maxsize = _c[0], setMaxSize = _c[1];
	    var viewprops = props.slice(0, maxsize);
	    return (react_1.default.createElement(react_1.default.Fragment, null, viewprops
	        .map(function (value, index) { return render(value, index); })
	        .concat(react_1.default.createElement("button", { style: button, onClick: function () { return setMaxSize(maxsize * 2); }, onMouseOver: over, onMouseOut: out(button), key: "jssjxp1z4x7f12lwfvk" }, maxsize < props.length ? '更多' : '到底了'))));
	}
	exports.Fold = Fold;
	});

	unwrapExports(fold);
	var fold_1 = fold.Fold;
	...
	exports.Link = function (_a) {
	    var props = _a.props, style = _a.style;
	    return (react_1.default.createElement(react_1.default.Fragment, null, props.map(function (_a, index) {
	        var name = _a.name, href = _a.href;
	        return (react_1.default.createElement("div", { key: "jssjzmjf5ls40k4z34c" + index },
	            react_1.default.createElement(anchor.Anchor, { name: name, href: href, style: style.a })));
	    })));
	};
	exports.LinkImg = function (_a) {
	    var props = _a.props, _b = _a.style, style = _b === void 0 ? {
	        a: {},
	        button: {},
	        div: {},
	        img: {},
	    ...
	    var img = style.img, p = style.p, a = style.a;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(fold.Fold, { props: props, style: style, render: function (_a, index) {
	                var name = _a.name, href = _a.href, src = _a.src, infor = _a.infor;
	                return (react_1.default.createElement(column.Columns, { props: { size: 3 }, style: style, key: "jssk1tfl7c1esj7id3e" + index },
	                    react_1.default.createElement("div", null,
	                        react_1.default.createElement(anchor.Anchor, { name: name, href: href, style: a })),
	                    react_1.default.createElement("div", null,
	                        react_1.default.createElement("img", { src: src, alt: name, style: img })),
	                    react_1.default.createElement("div", null,
	                        react_1.default.createElement("p", { style: p }, infor))));
	            } })));
	};
	});
	...
	var link_2 = link.LinkImg;

	var home$1 = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.Home = function (_a) {
	    var state = _a.state, style = _a.style;
	    var title = state.title, logo = state.logo, author = state.author, readME = state.readME, websites = state.websites;
	    var p = style.p, img = style.img;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("h1", { style: p }, title),
	        react_1.default.createElement("img", { src: logo, alt: title, style: img }),
	        react_1.default.createElement("p", { style: p }, author),
	        react_1.default.createElement("p", { style: p }, readME),
	        react_1.default.createElement(link.Link, { props: websites, style: style })));
	};
	});

	unwrapExports(home$1);
	var home_1 = home$1.Home;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var react_1 = __importDefault(react_production_min);
	var onFocus = function (defaultValue) { return function (event) {
	...
	var onBlur = function (defaultValue) { return function (event) {
	...
	exports.Input = function (_a) {
	    var _b = _a.style, style = _b === void 0 ? {} : _b, _c = _a.defaultValue, defaultValue = _c === void 0 ? '请输入...' : _c, onChange = _a.onChange, list = _a.list;
	    return (react_1.default.createElement("input", { type: "text", style: style, onChange: function (event) { return (onChange ? onChange(event) : null); }, onFocus: onFocus(defaultValue), onBlur: onBlur(defaultValue), defaultValue: defaultValue, list: list }));
	};
	});
	...
	var inputList = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.InputList = function (_a) {
	    var list = _a.list, _b = _a.listId, listId = _b === void 0 ? 'list' : _b, _c = _a.style, style = _c === void 0 ? {} : _c, defaultValue = _a.defaultValue, _d = _a.onChange, onChange = _d === void 0 ? function () { } : _d;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(input.Input, { list: listId, style: style, defaultValue: defaultValue, onChange: onChange }),
	        react_1.default.createElement("datalist", { id: listId }, list.map(function (l, i) { return (react_1.default.createElement("option", { value: l, key: 'jt4kzsouce4besj4leg' + i })); }))));
	};
	});

	unwrapExports(inputList);
	var inputList_1 = inputList.InputList;
	...
	function find(array, rule) {
	    return array.reduce(function (res, n) { return (rule(n) ? res.concat(n) : res); }, []);
	}
	exports.find = find;
	function Search(_a) {
	    var props = _a.props, onChange = _a.onChange, _b = _a.style, style = _b === void 0 ? {} : _b;
	    var findProp = function (keyword) {
	        return find(props, function (value) { return !!value.name.match(keyword); });
	    };
	    var change = function (event) {
	        return onChange(findProp(event.target.value));
	    };
	    var defaultValue = '搜索...';
	    return (react_1.default.createElement(inputList.InputList, { list: props.map(function (p) { return p.name; }), style: style, onChange: change, defaultValue: defaultValue }));
	}
	exports.Search = Search;
	});

	unwrapExports(search);
	var search_1 = search.find;
	var search_2 = search.Search;

	var project$1 = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.Project = function (_a) {
	    ...
	    var p = style.p;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(search.Search, { props: store.Store$.getInitState().project, onChange: function (v) { return store.Store$.setState({ project: v }); }, style: style.input }),
	        react_1.default.createElement(column.Columns, { props: { size: 3 }, style: style },
	            react_1.default.createElement("div", { style: p }, "Name"),
	            react_1.default.createElement("div", { style: p }, "View"),
	            react_1.default.createElement("div", { style: p }, "Infor")),
	        react_1.default.createElement(link.LinkImg, { props: state, style: style })));
	};
	});

	unwrapExports(project$1);
	var project_1 = project$1.Project;

	var blog_content_edit = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	var save = function (blogState, EditContent) { return function () {
	    return store.Store$.pipe(function (data) {
	        if (blogState === 'new') {
	            if (data.blog.items.find(function (b) { return b.name === EditContent.name; })) {
	                alert('标题名已存在！');
	            }
	            else {
	                data.blog.tabCur = 0;
	            ...
	            var index = data.blog.items.map(function (b) { return b.name; }).indexOf(EditContent.name);
	            EditContent.lastEdit = new Date().toLocaleString();
	            data.blog.items[index] = EditContent;
	        }
	        return data;
	    }, operations.blog_content_state('enter'), operations.blog_state('view'));
	}; };
	var back = function (blogState) { return function () {
	    return store.Store$.pipe(blogState === 'view'
	        ? operations.blog_content_state('enter')
	        : operations.blog_content_state('out'), operations.blog_state('view'));
	}; };
	exports.ContentEditor = function (_a) {
	    var state = _a.state, style = _a.style;
	    var blogState = state.blogState, contentCur = state.contentCur, items = state.items;
	    var button$1 = style.button, textarea = style.textarea, p = style.p, select = style.select, option = style.option;
	    var types = Array.from(new Set(items.map(function (i) { return i.type; })));
	    var EditContent = blogState === 'view'
	        ? items[contentCur]
	        : Object.assign(defaultInput, { type: types[0] });
	    var _b = react_1.useState('normal'), tInState = _b[0], setTInState = _b[1];
	    var inputcss = {
	    ...
	    var selectBtncss = __assign({}, button$1, { margin: '', height: '25px', padding: '' });
	    var TitleInput = function () { return (react_1.default.createElement("div", null,
	        react_1.default.createElement("span", { style: p }, "\u6807\u9898\uFF1A"),
	        react_1.default.createElement("input", { type: "text", defaultValue: EditContent.name, style: inputcss, onChange: function (e) { return (EditContent.name = e.target.value); } }))); };
	    var TypeInput = function () { return (react_1.default.createElement("div", null,
	        react_1.default.createElement("span", { style: p }, "\u5206\u7C7B\uFF1A"),
	        react_1.default.createElement("input", { type: "text", defaultValue: EditContent.type, style: inputcss, onChange: function (e) {
	                if (e.target.value === '#') {
	                    setTInState('normal');
	                }
	                else {
	    ...
	    var Select = function () { return (react_1.default.createElement("div", null,
	        react_1.default.createElement("span", { style: p }, "\u5206\u7C7B\uFF1A"),
	        react_1.default.createElement("select", { onChange: function (e) { return (EditContent.type = e.target.value); }, style: select }, types.map(function (t, index) { return (react_1.default.createElement("option", { value: t, style: option, key: index }, t)); })),
	        react_1.default.createElement(button.Button, { name: '新建分类', style: selectBtncss, onClick: function () { return setTInState('newtype'); } }))); };
	    var TypeSelect = function () {
	        if (blogState === 'new') {
	            if (tInState === 'normal') {
	                ...
	                return react_1.default.createElement(TypeInput, null);
	            }
	        }
	        else if (blogState === 'view') {
	            return null;
	    ...
	    var ContentInput = function () { return (react_1.default.createElement("div", null,
	        react_1.default.createElement("textarea", { defaultValue: EditContent.content, style: textarea, onChange: function (e) { return (EditContent.content = e.target.value); } }))); };
	    var Options = function () { return (react_1.default.createElement("div", null,
	        react_1.default.createElement(button.Button, { style: button$1, name: '保存', onClick: save(blogState, EditContent) }),
	        react_1.default.createElement(button.Button, { style: button$1, name: '返回', onClick: back(blogState) }))); };
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(TitleInput, null),
	        react_1.default.createElement(ContentInput, null),
	        react_1.default.createElement(TypeSelect, null),
	        react_1.default.createElement(Options, null)));
	};
	});

	unwrapExports(blog_content_edit);
	var blog_content_edit_1 = blog_content_edit.ContentEditor;

	var blog_header = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.Header = function (_a) {
	    var style = _a.style;
	    return (react_1.default.createElement(column.Columns, { props: { size: 2, col: '25% 75%' } },
	        react_1.default.createElement("div", null,
	            react_1.default.createElement(button.Button, { name: '写新日志', style: style.button, onClick: function () { return store.Store$.pipe(operations.blog_state('new')); } })),
	        react_1.default.createElement("div", null,
	            react_1.default.createElement(search.Search, { props: store.Store$.getInitState().blog.items, onChange: function (v) { return store.Store$.pipe(operations.blog_items(v)); }, style: style.input }))));
	};
	});

	unwrapExports(blog_header);
	var blog_header_1 = blog_header.Header;
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var react_1 = __importDefault(react_production_min);
	exports.Para = function (_a) {
	    var content = _a.content, _b = _a.style, style = _b === void 0 ? {} : _b;
	    return (react_1.default.createElement(react_1.default.Fragment, null, content.split('\n').map(function (line, index) { return (react_1.default.createElement("p", { style: style, key: "jssk84u20tjlxz2s2ych" + index }, line)); })));
	};
	});

	unwrapExports(paragraph);
	var paragraph_1 = paragraph.Para;
	 ...
	 */
	var react_1 = __importDefault(react_production_min);
	exports.findKeys = function (content, keys) {
	    var record = [];
	    keys.forEach(function (key) {
	        var pos = content.indexOf(key, 0);
	        while (pos !== -1) {
	            record.push({ type: key, index: pos });
	            pos = content.indexOf(key, pos + key.length);
	        }
	    });
	    return record.sort(function (a, b) { return a.index - b.index; });
	};
	exports.HighLight = function (_a) {
	    var content = _a.content, keywords = _a.keywords;
	    var finded = exports.findKeys(content, keywords.map(function (k) { return k.word; }));
	    var findColor = function (index) {
	        return keywords.find(function (keyword) { return keyword.word === finded[index].type; }).color;
	    };
	    var array = content
	        .split(new RegExp(keywords.map(function (keyword) { return keyword.word; }).join('|')))
	        .reduce(function (out, val, index) {
	        return finded[index]
	            ? out.concat(react_1.default.createElement("span", { key: "jssjy4fpsfemmey5tor" + index }, val), react_1.default.createElement("span", { style: { color: findColor(index) }, key: "jssjyad2o7ym9vuerr" + index }, finded[index].type))
	            : out.concat(react_1.default.createElement("span", { key: "jssjyjafaimd4jkph76" + index }, val));
	    }, []);
	    return react_1.default.createElement(react_1.default.Fragment, null, array);
	};
	});

	unwrapExports(highlight);
	var highlight_1 = highlight.findKeys;
	var highlight_2 = highlight.HighLight;

	var codeText = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	exports.dedup = function (array, key) {
	    return array.reduce(function (pre, cur) { return (pre.find(function (v) { return v[key] === cur[key]; }) ? pre : pre.concat(cur)); }, []);
	};
	exports.CodeText = function (_a) {
	    var content = _a.content, _b = _a.style, style = _b === void 0 ? { p: {}, pre: {} } : _b, _c = _a.start, start = _c === void 0 ? '```ts' : _c, _d = _a.end, end = _d === void 0 ? '```' : _d, keywords = _a.keywords;
	    var p = style.p, pre = style.pre;
	    var commonstyle = {
	        textAlign: 'left'
	    };
	    var pstyle = __assign({}, p, commonstyle);
	    var prestyle = __assign({}, pre, commonstyle, { overflow: 'scroll', overflowY: 'hidden' });
	    var $keywords = exports.dedup(keywords || exports.KEYWORDS, 'word');
	    return (react_1.default.createElement(react_1.default.Fragment, null, content.split(start).map(function (c, index) {
	        if (c.includes(end)) {
	            var result = c.split(end);
	            return (react_1.default.createElement("span", { key: "jssjw4dghn5i8lnpwxv" + index },
	                react_1.default.createElement("pre", null,
	                    react_1.default.createElement("p", { style: prestyle },
	                        react_1.default.createElement(highlight.HighLight, { content: result[0], keywords: $keywords }))),
	                react_1.default.createElement(paragraph.Para, { content: result[1], style: pstyle })));
	        }
	        else {
	            return (react_1.default.createElement(paragraph.Para, { content: c, style: pstyle, key: "jssjx2jjjebnh3do7lp" + index }));
	        }
	    })));
	};
	exports.KEYWORDS = [
	...
	unwrapExports(codeText);
	var codeText_1 = codeText.dedup;
	var codeText_2 = codeText.CodeText;
	var codeText_3 = codeText.KEYWORDS;

	var blog_content_enter = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	var edit = function (contentCur) { return function () {
	    return store.Store$.pipe(operations.blog_content_state('edit'), operations.blog_content_index(contentCur));
	}; };
	var remove = function (name) {
	    return store.Store$.pipe(operations.blog_content_del(name), operations.blog_content_state('out'));
	};
	var back = function () { return store.Store$.pipe(operations.blog_content_state('out')); };
	exports.ContentEnter = function (_a) {
	    var state = _a.state, style = _a.style;
	    var p = style.p, button$1 = style.button;
	    var items = state.items, contentCur = state.contentCur;
	    var _b = items[contentCur] || items[0], name = _b.name, content = _b.content, lastEdit = _b.lastEdit;
	    var _c = react_1.useState('删除'), label = _c[0], setLabel = _c[1];
	    var Options = function () { return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement(button.Button, { name: "\u7F16\u8F91", style: button$1, onClick: edit(contentCur) }),
	        react_1.default.createElement(button.Button, { name: label, style: button$1, onClick: function () {
	                if (label === '删除') {
	                    setLabel('确定删除？');
	                }
	                else if (label === '确定删除？') {
	        ...
	        react_1.default.createElement(button.Button, { name: '返回', onClick: back, style: button$1 }))); };
	    var Footer = function () { return (react_1.default.createElement("p", { style: __assign({}, p, { color: '#2a334d' }) }, "\u6700\u540E\u7F16\u8F91\u4E8E\uFF1A" + lastEdit)); };
	    return (react_1.default.createElement("div", null,
	        react_1.default.createElement("h1", { style: p }, name),
	        react_1.default.createElement(codeText.CodeText, { content: content, style: style }),
	...
	unwrapExports(blog_content_enter);
	var blog_content_enter_1 = blog_content_enter.ContentEnter;

	var blog_content_fold = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var record = function (cur, size) {
	    return (parseInt(String(cur / size)) + 1) * size;
	};
	var enter = function (index, tabCur) { return function () {
	    return store.Store$.pipe(operations.blog_content_index(index), operations.blog_tab_index(tabCur), operations.blog_content_state('enter'));
	}; };
	exports.ContentFold = function (_a) {
	    var state = _a.state, style = _a.style;
	    var div = style.div, hr = style.hr, a = style.a;
	    var items = state.items, contentCur = state.contentCur, tabCur = state.tabCur;
	    var Item = function (_a) {
	        var name = _a.name, index = _a.index;
	        return (react_1.default.createElement("div", { style: div },
	            react_1.default.createElement(anchor.Anchor, { name: name, href: '#', style: a, onClick: enter(index, tabCur) }),
	            react_1.default.createElement("hr", { style: hr })));
	    };
	    return (react_1.default.createElement(fold.Fold, { props: items, maxSize: record(contentCur, 6), render: function (_a, index) {
	            var name = _a.name;
	            return react_1.default.createElement(Item, { name: name, index: index });
	        }, style: style }));
	};
	});

	unwrapExports(blog_content_fold);
	var blog_content_fold_1 = blog_content_fold.ContentFold;

	var blog_content = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.Content = function (_a) {
	    ...
	    switch (contentState) {
	        case 'edit':
	            return react_1.default.createElement(blog_content_edit.ContentEditor, { state: state, style: style });
	        case 'enter':
	            return react_1.default.createElement(blog_content_enter.ContentEnter, { state: state, style: style });
	        case 'out':
	            return react_1.default.createElement(blog_content_fold.ContentFold, { state: state, style: style });
	        default:
	...
	unwrapExports(blog_content);
	var blog_content_1 = blog_content.Content;

	var globalcss = createCommonjsModule(function (module, exports) {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.globalcss = {
	    body: {
	...
	unwrapExports(globalcss);
	var globalcss_1 = globalcss.globalcss;

	var aboutcss = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	exports.aboutcss = {
	    p: __assign({}, globalcss.globalcss.p, { width: '80%', margin: '30px auto', fontSize: '95%' }),
	    a: globalcss.globalcss.a,
	    button: __assign({}, globalcss.globalcss.button, { border: '1px solid #282a36', color: '#2a334d', backgroundColor: '#252633', padding: '', marginTop: '30px', marginBottom: '20px' })
	};
	});

	unwrapExports(aboutcss);
	var aboutcss_1 = aboutcss.aboutcss;

	var homecss = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	exports.homecss = {
	    a: __assign({}, globalcss.globalcss.a, { fontSize: '150%' }),
	    img: globalcss.globalcss.img,
	    p: __assign({}, globalcss.globalcss.p, { fontSize: '120%' })
	};
	});

	unwrapExports(homecss);
	var homecss_1 = homecss.homecss;

	var projectcss = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	exports.projectcss = {
	    ...
	    a: __assign({}, globalcss.globalcss.a, { fontSize: '100%' }),
	    p: __assign({}, globalcss.globalcss.p, { fontSize: '100%', width: '70%', margin: '30px auto', lineHeight: '150%' }),
	    input: globalcss.globalcss.input,
	    button: __assign({}, globalcss.globalcss.button, { color: '#2a334d', background: '#252633', border: '1px solid #282a36', marginTop: '5%', marginBottom: '5%' })
	};
	});

	unwrapExports(projectcss);
	var projectcss_1 = projectcss.projectcss;

	var tabscss = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	var tabsLength = 4;
	var tabswidth = 100 / tabsLength + "%";
	var common = {
	    button: __assign({}, globalcss.globalcss.button, { width: tabswidth, fontSize: '120%' }),
	    bottom: globalcss.globalcss.bottom,
	    hr: globalcss.globalcss.hr
	};
	exports.tabscss = {
	    active: __assign({}, common, { button: __assign({}, common.button, { color: '#6272a4', backgroundColor: '#282a36', boxShadow: '#000000 -5px 5px 10px' }) }),
	    unactive: __assign({}, common, { button: __assign({}, common.button, { color: '#2a334d', backgroundColor: '#191a21', boxShadow: '' }) })
	};
	});

	unwrapExports(tabscss);
	var tabscss_1 = tabscss.tabscss;

	var blogcss = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	exports.tabVcss = {
	    active: {
	        button: __assign({}, globalcss.globalcss.button, common.button, { color: '#6272a4' })
	    },
	    unactive: {
	        button: __assign({}, globalcss.globalcss.button, common.button, { color: '#2a334d' })
	    }
	};
	exports.blogcss = {
	    ...
	    hr: {},
	    button: __assign({}, globalcss.globalcss.button, { color: '#2a334d', background: '#252633', border: '1px solid #282a36', marginTop: '5%', marginBottom: '5%' }),
	    input: __assign({}, globalcss.globalcss.input, { marginTop: '20px' }),
	    a: __assign({}, globalcss.globalcss.a, { margin: '0 auto', fontSize: '100%', cursor: 'pointer', lineHeight: '10%', fontFamily: globalcss.globalcss.p.fontFamily }),
	    p: __assign({}, globalcss.globalcss.p, { fontSize: '90%', color: '#799cb9', margin: '10px auto' }),
	    textarea: globalcss.globalcss.textarea,
	    pre: __assign({}, globalcss.globalcss.p, { fontSize: '105%', color: '#8dc0a5', margin: '10px auto', fontFamily: '' }),
	    select: __assign({}, globalcss.globalcss.select, { marginTop: '20px' }),
	    option: __assign({}, globalcss.globalcss.option)
	};
	});

	unwrapExports(blogcss);
	var blogcss_1 = blogcss.tabVcss;
	var blogcss_2 = blogcss.blogcss;

	var logincss = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	exports.logincss = {
	    div: __assign({}, globalcss.globalcss.div, { width: '300px', marginLeft: 'auto', marginRight: 'auto', marginTop: '3%' }),
	    p: __assign({}, globalcss.globalcss.p, { fontSize: '100%', margin: '10px auto' }),
	    input: __assign({}, globalcss.globalcss.input, { margin: '10px auto' }),
	    a: __assign({}, globalcss.globalcss.a, { fontSize: '80%' }),
	    button: __assign({}, globalcss.globalcss.button, { border: '1px solid #282a36', color: '#2a334d', backgroundColor: '#191a21', padding: '' }),
	    hr: __assign({}, globalcss.globalcss.hr),
	    bottom: __assign({}, globalcss.globalcss.bottom)
	};
	});

	unwrapExports(logincss);
	var logincss_1 = logincss.logincss;
	...
	var blog_tab = createCommonjsModule(function (module, exports) {
	var __assign = (commonjsGlobal && commonjsGlobal.__assign) || function () {
	    __assign = Object.assign || function(t) {
	        for (var s, i = 1, n = arguments.length; i < n; i++) {
	            s = arguments[i];
	...
	var out = function (index) {
	    return store.Store$.pipe(operations.blog_tab_index(index), operations.blog_content_state('out'));
	};
	exports.TabContent = function (_a) {
	    var state = _a.state, style = _a.style;
	    var items = state.items, tabCur = state.tabCur;
	    var tabs = Array.from(new Set(items.map(function (v) { return v.type; }))).map(function (t, index) { return (react_1.default.createElement(tab.Tab, { name: t, key: index },
	        react_1.default.createElement(blog_content.Content, { state: __assign({}, state, { items: search.find(items, function (v) { return v.type === t; }) }), style: style }))); });
	    return (react_1.default.createElement(tab.TabV, { col: '25% 75%', active: css.tabVcss.active, unactive: css.tabVcss.unactive, current: tabCur, onClick: out }, tabs));
	};
	});

	unwrapExports(blog_tab);
	var blog_tab_1 = blog_tab.TabContent;

	var blog$1 = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.Blog = function (_a) {
	    var state = _a.state, style = _a.style;
	    var blogState = state.blogState;
	    switch (blogState) {
	        case 'new':
	            return (react_1.default.createElement("div", { style: style.div },
	                react_1.default.createElement(blog_content_edit.ContentEditor, { state: state, style: style })));
	        case 'view':
	            return (react_1.default.createElement("div", { style: style.div },
	                react_1.default.createElement(blog_header.Header, { style: style }),
	                react_1.default.createElement(blog_tab.TabContent, { state: state, style: style })));
	        default:
	...
	unwrapExports(blog$1);
	var blog_1 = blog$1.Blog;

	var about$1 = createCommonjsModule(function (module, exports) {
	var __importDefault = (commonjsGlobal && commonjsGlobal.__importDefault) || function (mod) {
	    return (mod && mod.__esModule) ? mod : { "default": mod };
	};
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	exports.About = function (_a) {
	    var state = _a.state, style = _a.style;
	    var title = state.title, content = state.content, more = state.more, contact = state.contact, links = state.links;
	    var p = style.p, button$1 = style.button;
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("h1", { style: p }, title),
	        react_1.default.createElement("p", { style: p }, content),
	        react_1.default.createElement("p", { style: p }, more),
	        react_1.default.createElement("h1", { style: p }, contact),
	        react_1.default.createElement(link.Link, { props: links, style: style }),
	        react_1.default.createElement(button.Button, { name: "\u5207\u6362\u767B\u5F55", style: button$1, onClick: function () { return store.Store$.setState({ login: false, tabCur: 0 }); } })));
	};
	});

	unwrapExports(about$1);
	var about_1 = about$1.About;
	...
	var pass = function (user) {
	    ...
	    var target = users.find(function (u) { return u.id === user.id; });
	    if (target) {
	...
	exports.Login = function (_a) {
	    var style = _a.style, onSuccess = _a.onSuccess;
	    var div = style.div, p = style.p, input$1 = style.input, button$1 = style.button, a = style.a, bottom = style.bottom, hr = style.hr;
	    var user = {
	        id: '',
	        password: ''
	    };
	    ...
	    return (react_1.default.createElement("div", { style: div },
	        react_1.default.createElement("form", { onSubmit: function (e) {
	            ...
	            react_1.default.createElement("p", { style: p }, '登录'),
	            react_1.default.createElement("hr", { style: hr }),
	            react_1.default.createElement("div", null,
	                react_1.default.createElement(input.Input, { style: input$1, defaultValue: "\u8BF7\u8F93\u5165id...(saber2pr)", onChange: function (e) { return (user.id = e.target.value); } })),
	            react_1.default.createElement("div", null,
	                react_1.default.createElement(input.Input, { style: input$1, defaultValue: "\u8BF7\u8F93\u5165\u5BC6\u7801...(123)", onChange: function (e) { return (user.password = e.target.value); } })),
	            react_1.default.createElement("br", null),
	            react_1.default.createElement("div", null,
	                react_1.default.createElement(button.Button, { style: button$1, name: "\u786E\u5B9A" }),
	                react_1.default.createElement(button.Button, { style: button$1, name: "\u6E38\u5BA2\u8EAB\u4EFD", onClick: onSuccess })),
	            react_1.default.createElement("br", null),
	            react_1.default.createElement("div", null,
	                react_1.default.createElement(anchor.Anchor, { style: a, name: "\u6CA1\u6709\u5E10\u53F7\uFF1F\u6CE8\u518C>>", href: "#", onClick: register }))),
	        react_1.default.createElement("br", null),
	        react_1.default.createElement("hr", { style: hr }),
	        react_1.default.createElement("div", { style: bottom }, 'saber2pr.github.io')));
	};
	...
	unwrapExports(login$1);
	var login_1 = login$1.Login;
	...
	exports.Application = function (_a) {
	    var state = _a.state;
	    var staticState = state.staticState, home = state.home, blog = state.blog, project = state.project, about = state.about, tabCur = state.tabCur, login = state.login;
	    var footer = staticState.footer;
	    var div = css.globalcss.div;
	    if (login) {
	        return (react_1.default.createElement("div", { style: div },
	            react_1.default.createElement(tab.Tabs, { active: css.tabscss.active, unactive: css.tabscss.unactive, bottom: footer, current: tabCur, onClick: function (index) {
	                    return store.Store$.setState({ tabCur: index }).pipe(operations.blog_items_reset(store.Store$.getInitState().blog.items), operations.project_reset(store.Store$.getInitState().project));
	                } },
	                react_1.default.createElement(tab.Tab, { name: "Home" },
	                    react_1.default.createElement(home$1.Home, { state: home, style: css.homecss })),
	                react_1.default.createElement(tab.Tab, { name: "Blog" },
	                    react_1.default.createElement(blog$1.Blog, { state: blog, style: css.blogcss })),
	                react_1.default.createElement(tab.Tab, { name: "Project" },
	                    react_1.default.createElement(project$1.Project, { state: project, style: css.projectcss })),
	                react_1.default.createElement(tab.Tab, { name: "About" },
	                    react_1.default.createElement(about$1.About, { state: about, style: css.aboutcss })))));
	    }
	    else {
	        return (react_1.default.createElement(login$1.Login, { style: css.logincss, onSuccess: function () { return store.Store$.setState({ login: true }); } }));
	    }
	};
	});
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var react_1 = __importDefault(react_production_min);
	var react_dom_1 = __importDefault(reactDom_production_min);




	store.Store$.subscribe(function (state) {
	    return react_dom_1.default.render(react_1.default.createElement(Application.Application, { state: state }), document.querySelector('#root'));
	});
	style.style(document.querySelector('body'))(css.globalcss.body);
	});
