...
var saber2pr = (function () {
	...
	*/
	...
	exports.Columns = function (_a) {
	    ...
	    var div = style.div;
	    return (react_1.default.createElement("div", { style: __assign({}, div, { display: 'grid', gridTemplateColumns: props.col || (" " + 100 / size + "% ").repeat(size) }) }, children));
	};
	});
	...
	function Fold(_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null, viewprops
	        ...
	        .concat(react_1.default.createElement("button", { style: button, onClick: function () { return setMaxSize(maxsize * 2); }, onMouseOver: over, onMouseOut: out(button) }, maxsize < props.length ? 'more' : 'end'))));
	}
	exports.Fold = Fold;
	});
	...
	exports.aboutcss = {
	    p: __assign({}, globalcss.globalcss.p, { width: '80%', margin: '30px auto', lineHeight: '160%', fontSize: '100%' }),
	...
	var common = {
	    button: __assign({}, globalcss.globalcss.button, { width: tabswidth, fontSize: '150%' }),
	...
	var Content = function (_a) {
	    var props = _a.props, style = _a.style;
	    var hr = style.hr, div = style.div, button$$1 = style.button;
	    var _b = react_1.useState('out'), state = _b[0], setState = _b[1];
	    var _c = react_1.useState(0), cur = _c[0], setCur = _c[1];
	    var fold$$1 = (react_1.default.createElement(fold.Fold, { props: props, maxSize: 6, render: function (_a, index) {
	            var name = _a.name;
	        ...
	        }, style: { button: button$$1 } }));
	    if (state === 'out') {
	        return fold$$1;
	    }
	    else if (state === 'enter') {
	        return (react_1.default.createElement("div", null,
	            react_1.default.createElement("p", null, props[cur].content),
	            react_1.default.createElement(button.Button, { name: 'back', onClick: function () { return setState('out'); }, style: button$$1 })));
	    }
	};
	var Tabs = function (_a) {
	    ...
	    return Array.from(new Set(props.map(function (v) { return v.type; }))).map(function (t) { return (react_1.default.createElement(tab.Tab, { name: t },
	        react_1.default.createElement(Content, { props: search.find(props, function (v) { return v.type === t; }), style: style }))); });
	};
	exports.Blog = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("div", { style: div },
	            react_1.default.createElement(search.Search, { props: props, onChange: function (v) { return setSearched(v); }, style: style }),
	            react_1.default.createElement(tab.TabV, { col: '25% 75%', active: css.tabVcss.active, unactive: css.tabVcss.unactive }, Tabs({ props: searched, style: style })))));
	};
	});
	    ...
	    return (react_1.default.createElement("div", { style: div },
	        react_1.default.createElement(tab.Tabs, { active: css.tabscss.active, unactive: css.tabscss.unactive, bottom: footer },
	            react_1.default.createElement(tab.Tab, { name: "Home" },
	                react_1.default.createElement(home.Home, { props: home$$1, style: css.globalcss })),
