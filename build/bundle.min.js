...
var saber2pr = (function () {
	...
	*/
	...
	var about$2 = {
		title: "说明",
		content: "这是一个用来组织和导航saber2pr的Repositories的页面，使用react（16.8.2）编写。语言为React-Typescript（tsx），层叠样式表为css in js。采用函数组件，状态更新使用React-Hooks，",
		links: [
			{
	...
	react_dom_1.default.render(react_1.default.createElement(Application, __assign({}, css.data)), container);
	});
