...
var saber2pr = (function () {
	...
	*/
	...
	exports.Columns = function (_a) {
	    var props = _a.props, children = _a.children, style = _a.style;
	...
	var over = function (active) { return function (event) {
	    return style.style(event.target)({
	        color: active.color,
	        boxShadow: active.boxShadow
	    });
	}; };
	var out = function (isactive, active, unactive) { return function (event) {
	    return style.style(event.target)({
	...
	function Tabs(_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null, react_1.default.Children.map(children, function (node, index) { return (react_1.default.createElement("button", { style: index === cur ? active.button : unactive.button, key: index, onClick: function () { return update(index); }, onMouseOver: over(active.button), onMouseOut: out(index === cur, active.button, unactive.button) }, node['props']['name'])); })
	...
	exports.TabV = function (_a) {
	    ...
	    var tabs = react_1.default.Children.map(children, function (node, index) { return (react_1.default.createElement("div", null,
	        react_1.default.createElement("button", { style: index === cur ? active.button : unactive.button, key: index, onClick: function () { return update(index); }, onMouseOver: over(active.button), onMouseOut: out(index === cur, active.button, unactive.button) }, node['props']['name']))); });
	    var content = children[cur] || children;
	    return (react_1.default.createElement(column.Columns, { props: { size: 2, col: col }, style: { div: {} } },
	...
	exports.Anchor = function (_a) {
	    var props = _a.props, style$$1 = _a.style;
	    var href = props.href, name = props.name;
	    var a = style$$1.a;
	    return (react_1.default.createElement("a", { href: href, style: a, onMouseOver: over, onMouseOut: out }, name));
	};
	});
	...
	exports.Link = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null, props.map(function (_a, index) {
	        ...
	        return (react_1.default.createElement("div", { key: index },
	            react_1.default.createElement(anchor.Anchor, { props: { name: name, href: href }, style: style, key: index })));
	    })));
	};
	...
	exports.blogcss = {
	    ...
	    hr: {},
	    button: __assign({}, globalcss.globalcss.button, { color: '#2a334d', background: '#252633', border: '1px solid #282a36', marginTop: '5%', marginBottom: '5%' }),
	    input: __assign({}, globalcss.globalcss.input, { marginTop: '10px' })
	};
	});
	...
	var Content = function (_a) {
	    var props = _a.props, style = _a.style;
	    var hr = style.hr, div = style.div, button = style.button;
	    return (react_1.default.createElement(fold.Fold, { props: props, maxSize: 6, render: function (_a) {
	...
	exports.Blog = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("div", { style: div },
	            react_1.default.createElement(search.Search, { props: props, onChange: function (v) { return setSearched(v); }, style: style }),
	            react_1.default.createElement(tab.TabV, { col: '20% 80%', active: css.tabVcss.active, unactive: css.tabVcss.unactive }, Tabs({ props: searched, style: style })))));
	};
	});
