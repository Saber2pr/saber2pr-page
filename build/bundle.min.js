...
var saber2pr = (function () {
	...
	*/
	...
	var ContentNode = function (_a) {
	    var props = _a.props, style = _a.style, onOut = _a.onOut, current = _a.current;
	    ...
	    return (react_1.default.createElement("div", null,
	        ...
	        react_1.default.createElement(button.Button, { name: "\u5220\u9664", style: button$$1, onClick: onOut }),
	...
	exports.Content = function (_a) {
	    ...
	    if (state === 'out') {
	        ...
	        return react_1.default.createElement(ContentNode, { props: props, style: style, onOut: Out, current: cur });
	    }
	};
	});
	...
	var Tabs = function (_a) {
	    var props = _a.props, style = _a.style;
	    return Array.from(new Set(props.map(function (v) { return v.type; }))).map(function (t) { return (react_1.default.createElement(tab.Tab, { name: t },
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        react_1.default.createElement("div", { style: div },
	            react_1.default.createElement(column.Columns, { props: { size: 2, col: '25% 75%' } },
	                ...
	                react_1.default.createElement("div", null,
	                    react_1.default.createElement(search.Search, { props: props, onChange: function (v) { return setData(v); }, style: style }))),
	            react_1.default.createElement(tab.TabV, { col: '25% 75%', active: css.tabVcss.active, unactive: css.tabVcss.unactive }, Tabs({ props: data, style: style })))));
	};
	});
