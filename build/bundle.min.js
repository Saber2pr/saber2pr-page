...
var saber2pr = (function () {
	...
	*/
	...
	exports.Search = function (_a) {
	    ...
	    return (react_1.default.createElement("input", { type: "text", style: input, onChange: change, onFocus: onFocus(defaultValue), defaultValue: defaultValue }));
	};
	});
	...
	exports.About = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null,
	        ...
	        react_1.default.createElement("p", { style: p }, contact),
	...
	var about$2 = {
		title: "说明",
		content: "这是一个用来组织和导航saber2pr/Repositories的页面。使用react（16.8.2）编写，配色风格参考Dracula Official。语言为React-Typescript（tsx），层叠样式表为css in js，栅格布局为grid格式。采用函数组件，状态更新使用React-Hooks。tab导航原理为props.children动态渲染，a标签hover原理为onMouseOver & onMouseOut动态切换css阴影，input搜索原理为正则match & children动态渲染。项目的单元工具（utils）已经同步到npm。",
	...
	exports.aboutcss = {
	    p: __assign({}, exports.globalcss.p, { width: '70%', margin: '30px auto', lineHeight: '160%', fontSize: '100%' }),
