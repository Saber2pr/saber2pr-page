...
var saber2pr = (function () {
	...
	*/
	...
	exports.Anchor = function (_a) {
	    ...
	    var href = props.href, name = props.name, over = props.over, out = props.out;
	    var a = style.a;
	...
	exports.Link = function (_a) {
	    ...
	    return (react_1.default.createElement(react_1.default.Fragment, null, props.map(function (_a, index) {
	        ...
	        return (react_1.default.createElement("div", { key: index },
	            react_1.default.createElement(element.Anchor, { props: { name: name, href: href, out: out, over: over }, style: style$$1, key: index })));
	    })));
	};
	exports.LinkImg = function (_a) {
	    var props = _a.props, style$$1 = _a.style;
	    var a = style$$1.a, img = style$$1.img;
	    return (react_1.default.createElement(react_1.default.Fragment, null, props.map(function (_a, index) {
	        var name = _a.name, href = _a.href, src = _a.src;
	        return (react_1.default.createElement(react_1.default.Fragment, null,
	            react_1.default.createElement("div", { key: index },
	                react_1.default.createElement(element.Anchor, { props: { name: name, href: href, out: out, over: over }, style: { a: a }, key: index })),
	            react_1.default.createElement("div", { key: index },
	...
	exports.Project = function (_a) {
	    var props = _a.props, style = _a.style;
	    return (react_1.default.createElement(link.LinkImg, { props: props, style: style }));
	};
	});
	...
	exports.About = function (_a) {
	    var props = _a.props, style = _a.style;
	    var content = props.content, title = props.title, links = props.links;
	...
	var about$2 = {
		title: "说明",
		content: "这是一个用来组织和导航saber2pr的Repositories的页面，使用react（16.8.2）编写。语言为React-Typescript（tsx），层叠样式表为css in js。采用函数组件，状态更新使用React-Hooks，tab导航原理为props.children动态更新，a标签hover原理为onMouseOver & onMouseOut动态切换css阴影。项目的单元工具（utils）已经同步到npm。",
		links: [
			{
	...
	exports.globalcss = {
	    ...
	    button: {
	        width: 100 / Object.keys(exports.data).length + "%",
	...
	exports.aboutcss = {
	    p: __assign({}, exports.globalcss.p, { width: '70%', margin: '30px auto' }),
	    a: exports.globalcss.a
	};
	});
	...
	var Application = function (_a) {
	    var home$$1 = _a.home, project$$1 = _a.project, about$$1 = _a.about;
	    var div = css.globalcss.div;
	    return (react_1.default.createElement("div", { style: div },
	        react_1.default.createElement(tab.Tabs, { active: css.tabscss.active, unactive: css.tabscss.unactive },
